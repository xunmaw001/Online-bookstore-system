  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="图书名称" prop="tushumingcheng">
              <el-input v-model="ruleForm.tushumingcheng" 
                placeholder="图书名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="图书评价" prop="tushupingjia">
          <el-select v-model="ruleForm.tushupingjia" placeholder="请选择图书评价">
            <el-option
                v-for="(item,index) in tushupingjiaOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="图书评价" prop="tushupingjia">
	      <el-input v-model="ruleForm.tushupingjia"
                placeholder="图书评价" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="图书质量" prop="tushuzhiliang">
          <el-select v-model="ruleForm.tushuzhiliang" placeholder="请选择图书质量">
            <el-option
                v-for="(item,index) in tushuzhiliangOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="图书质量" prop="tushuzhiliang">
	      <el-input v-model="ruleForm.tushuzhiliang"
                placeholder="图书质量" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="综合评分" prop="zonghepingfen">
        ...
        <div v-else>
          <el-form-item class="input" label="综合评分" prop="zonghepingfen">
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.tushumingcheng = true;
            continue;
	            	            ...
	            	            if(o=='tushupingjia'){
            this.ruleForm.tushupingjia = obj[o];
	    this.ro.tushupingjia = true;
            continue;
          }
	            	            if(o=='tushuzhiliang'){
            this.ruleForm.tushuzhiliang = obj[o];
	    this.ro.tushuzhiliang = true;
            continue;
          }
	            	            if(o=='zonghepingfen'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                                                              ...
                                                                              this.tushupingjiaOptions = "1星,2星,3星,4星,5星".split(',')
                                        this.tushuzhiliangOptions = "1星,2星,3星,4星,5星".split(',')
                                        this.zonghepingfenOptions = "6,7,8,9,10".split(',')
                                                                                  },
                                                                        // 多级联动参数
                                                                                            info(id) {
      this.$http({
