  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="图书名称" prop="tushumingcheng">
              <el-input v-model="ruleForm.tushumingcheng" 
                placeholder="图书名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="一级分类" prop="yijifenlei">
          <el-select v-model="ruleForm.yijifenlei" placeholder="请选择一级分类">
            <el-option
                v-for="(item,index) in yijifenleiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="一级分类" prop="yijifenlei">
	      <el-input v-model="ruleForm.yijifenlei"
                placeholder="一级分类" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="二级分类" prop="erjifenlei">
          <el-select v-model="ruleForm.erjifenlei" placeholder="请选择二级分类">
            <el-option
                v-for="(item,index) in erjifenleiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="二级分类" prop="erjifenlei">
	      <el-input v-model="ruleForm.erjifenlei"
                placeholder="二级分类" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="24">  
          ...
          <el-form-item class="input" label="出版社" prop="chubanshe">
              <el-input v-model="ruleForm.chubanshe" 
                placeholder="出版社" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="出版时间" prop="chubanshijian">
          <el-input v-model="ruleForm.chubanshijian" 
              placeholder="出版时间" clearable  :readonly="ro.chubanshijian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="出版时间" prop="chubanshijian">
              <el-input v-model="ruleForm.chubanshijian" 
                placeholder="出版时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                                                                                                                                          <el-col :span="12">
            ...
            <el-col :span="24">
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.jianjie" label="简介" prop="jianjie">
                    <span v-html="ruleForm.jianjie"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.tushumingcheng = true;
            continue;
	            	            ...
	            	            if(o=='yijifenlei'){
            this.ruleForm.yijifenlei = obj[o];
	    this.ro.yijifenlei = true;
            continue;
          }
	            	            if(o=='erjifenlei'){
            this.ruleForm.erjifenlei = obj[o];
	    this.ro.erjifenlei = true;
            continue;
          }
	            	            if(o=='tupian'){
	...
	this.ruleForm.jianjie = this.ruleForm.jianjie.replace(reg,'../../../ssm394a7/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
