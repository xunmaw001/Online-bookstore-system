<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="统计编号" prop="tongjibianhao">
            <el-input v-model="ruleForm.tongjibianhao" 
                placeholder="统计编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.tongjibianhao" label="统计编号" prop="tongjibianhao">
              <el-input v-model="ruleForm.tongjibianhao" 
                placeholder="统计编号" readonly></el-input>
          </el-form-item>
        </div>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'" label="图书编号" prop="tushubianhao">
          <el-select  @change="tushubianhaoChange" v-model="ruleForm.tushubianhao" placeholder="请选择图书编号">
            <el-option
                v-for="(item,index) in tushubianhaoOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
          ...
          <el-form-item class="input" label="图书名称" prop="tushumingcheng">
              <el-input v-model="ruleForm.tushumingcheng" 
                placeholder="图书名称" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="销售量" prop="xiaoshouliang">
          <el-input v-model="ruleForm.xiaoshouliang" 
              placeholder="销售量" clearable  :readonly="ro.xiaoshouliang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="销售量" prop="xiaoshouliang">
              <el-input v-model="ruleForm.xiaoshouliang" 
                placeholder="销售量" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="点击量" prop="dianjiliang">
          <el-input v-model="ruleForm.dianjiliang" 
              placeholder="点击量" clearable  :readonly="ro.dianjiliang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="点击量" prop="dianjiliang">
              <el-input v-model="ruleForm.dianjiliang" 
                placeholder="点击量" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" v-if="ruleForm.dengjishijian" label="登记时间" prop="dengjishijian">
              <el-input v-model="ruleForm.dengjishijian" 
                placeholder="登记时间" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="登记人" prop="dengjiren">
          <el-input v-model="ruleForm.dengjiren" 
              placeholder="登记人" clearable  :readonly="ro.dengjiren"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="登记人" prop="dengjiren">
              <el-input v-model="ruleForm.dengjiren" 
                placeholder="登记人" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                            </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xiaoshouliang = true;
            continue;
	            	            ...
	            	            if(o=='dianjiliang'){
            this.ruleForm.dianjiliang = obj[o];
	    this.ro.dianjiliang = true;
            continue;
          }
	            	            if(o=='dengjishijian'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                                            ...
                                                            this.$http({
              url: `option/tushuxinxi/tushubianhao`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
                this.tushubianhaoOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
    ...
    tushubianhaoChange () {
      this.$http({
        url: `follow/tushuxinxi/tushubianhao?columnValue=`+ this.ruleForm.tushubianhao,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
                                                                                if(data.data.tushumingcheng){
                this.ruleForm.tushumingcheng = data.data.tushumingcheng
              }
                                                                                                                                            } else {
          this.$message.error(data.msg);
        }
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `tushutongji/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.tushutongjiCrossAddOrUpdateFlag = false;
                  this.parent.search();
