...
import center from '@/views/center'
    ...
    import erjifenlei from '@/views/modules/erjifenlei/list'
    import dingdanpingjia from '@/views/modules/dingdanpingjia/list'
    import yijifenlei from '@/views/modules/yijifenlei/list'
    import yonghu from '@/views/modules/yonghu/list'
    import tushutongji from '@/views/modules/tushutongji/list'
